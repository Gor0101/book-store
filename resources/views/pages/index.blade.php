...
@section('content')
    @if(Auth::user() && $user->subscriptions->isEmpty())
                ...
                <svg xmlns="http://www.w3.org/2000/svg" id="store" viewBox="130 0 1230 930">
                    <defs>
                        ...
                        <g id="plane">
                            ...
                            <text transform="matrix(1.0027 0 0 1 44.8218 224.8768)" font-family='Fredoka One' font-size="34" fill="#0170BB"> Welcome to BookStore</text>
                    ...
                    <g id="door">
                        ...
                        <g id="sign">
                            ...
                            <text transform="matrix(1.0027 0 0 1 789.6294 721.7501)" fill="#FFF" font-family='Fredoka One' font-size="38">
                                <a href="{{route('RegistrationUserPage')}}" style="text-decoration: none;">Sign up</a> </text>
                ...
                <svg xmlns="http://www.w3.org/2000/svg" id="store" viewBox="130 0 1230 930">
                    ...
                    <g id="door">
                        ...
                        <g id="sign">
                            ...
                            <path fill="#a5c7e4" d="M909.3 740.7H775.1c-5.5 0-10-4.5-10-10v-47.9c0-5.5 4.5-10 10-10h134.2c5.5 0 10 4.5 10 10v47.9C919.3 736.2 914.8 740.7 909.3 740.7z"/>
                            <text transform="matrix(1.0027 0 0 1 789.6294 721.7501)" fill="#FFF" font-family='Fredoka One' font-size="38">
                                <a href="{{route('UserProfilePage',Auth::id())}}" style="text-decoration: none;">{{Auth::user()->name}}</a> </text>
                            <path fill="none" class="stroke" d="M909.3 740.7H775.1c-5.5 0-10-4.5-10-10v-47.9c0-5.5 4.5-10 10-10h134.2c5.5 0 10 4.5 10 10v47.9C919.3 736.2 914.8 740.7 909.3 740.7z"/>
                        </g>
                    </g>
                    <g id="button">
