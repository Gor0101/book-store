        ...
        <div class="page-inner row">
            @foreach($books as $book)
                <div class="col-3 offset-1 el-wrapper ms-4">
                    <div class="box-up">
                        <img class="img" src="{{ $book->book_avatar }}" alt="">
                        <div class="img-info">
                            <div class="info-inner">
                                <span class="p-name">{{ $book->name  }}</span>
                                <span class="p-genre">Genre is: {{ $book->genre->genre }}</span>
                                <span class="p-author">Author is: {{ $book->user->name }}</span>
                            </div>
                        </div>
                    </div>
                    <div class="box-down">
